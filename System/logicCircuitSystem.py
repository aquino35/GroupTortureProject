...
class LogicCircuitSystem():
    ...
    def __init__(self, layered_comp_list, num_of_runs):
        """
            Description:
            The System takes a layered_comp_list and establishes an order so then it can run
            depending on the nums_of_runs and the given order that the system has provided.
        ...
        self.textFile = open('Simulation.txt', 'w') # initiating textfile describing the what happens in between runs.
